...
rtype_metall = new ResourceType("metall", 3, {ore: 3}, 180)
...
// this thing will cover player's actions from X'Ellar
rtype_blinding_orb = new ResourceType("b_orb", 8, {metall: 80, junk: 20})
